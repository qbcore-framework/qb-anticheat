...
AddEventHandler('qb-anticheat:server:banPlayer', function(reason)
    ...
    exports.ghmattimysql:execute("INSERT INTO `bans` (`name`, `steam`, `license`, `discord`,`ip`, `reason`, `expire`, `bannedby`) VALUES ('"..GetPlayerName(src).."', '"..GetPlayerIdentifiers(src)[1].."', '"..GetPlayerIdentifiers(src)[2].."', '"..GetPlayerIdentifiers(src)[3].."', '"..GetPlayerIdentifiers(src)[4].."', '"..reason.."', 2145913200, '"..GetPlayerName(src).."')")
    DropPlayer(src, "You have been flagged too many times by our anticheat and prevented from being banned from the server. Check our discord for more information: https://discord.gg/cYwKMKX")
end)
